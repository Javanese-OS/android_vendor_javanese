...
else ifeq ($(JAVANESE_GAPPS_TYPE), microg)
     JAVANESE_BUILD_GAPPS_TYPE := MICROG
else ifeq ($(JAVANESE_GAPPS_TYPE), gapps)
...
JAVANESE_VERSION := JavaneseOS-v$(JAVANESE_PLATFORM_VERSION)-$(JAVANESE_BUILD)-$(JAVANESE_BUILD_TYPE)-$(JAVANESE_BUILD_GAPPS_TYPE)-$(JAVANESE_BUILD_DATE)
